            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarLightDropdownMenuLink">
                  <li class="my-auto"><a class="dropdown-item" href="https://discord.gg/9zyZbD6J7H" target="_blank"><i class="fab fa-discord me-2 my-auto"></i>Discord</a></li>

                  <li class="my-auto"><a class="dropdown-item" href="https://github.com/GenieFramework" target="_blank"><i class="fab fa-github me-2 my-auto mt-1"></i>Github</a></li>

                  <li class="my-auto"><a class="dropdown-item" href="https://gitter.im/essenciary/Genie.jl" target="_blank"><i class="fab fa-gitter ms-1 my-auto mt-1"></i>Gitter</a></li>
                </ul>
              </li>
            </ul>
          </div>
  ...
  <!-- B R E A D C R U M B  (D E S K T O P) -->
    <div class="container-fluid breadcrumb-desktop">
      <div class="container my-auto mx-auto breadcrumb-desktop">
        <p class="my-auto">
            <a class="level-1-breadcrumb is-disabled" id="level-1-breadcrumb" href="">Tutorials</a>
  ...
  <!-- N A V 2  (M O B I L E) -->
    <div class="container-fluid py-2 px-4 flex-row justify-content-between nav2-mobile sticky-top">
      <div class="my-auto d-flex flex-start">
        <div id="hamburger" class="my-auto" onclick="showSideBar()">
          <img src="/assets/img/hamburger.svg" alt="hamburger" height="22">
        </div>
        <div class="my-auto">
      ...
      <div class="my-auto loupe" onclick="showSearchBar()">
        <img id="loupe" src="/assets/img/loupe.svg" height="18" alt="loupe"></img>
      </div>
      ...
      <div id="cancel" class="my-auto" onclick="hideSearchBar()">
        <img src="/assets/img/cancel.svg" alt="cancel" height="14">
      </div>
    </div>
...
<!-- F O O T E R -->
  ...
  <footer class="py-5 px-3 mt-auto">
    <div class="container p-2">
        <div class="corporative-footer pt-2 pb-4 me-5">
            <h6 class="mb-1 mt-0"><span class="bold">Genie</span><span class="light very-squeezed">Framework</span></h6>
            <small>©2022 | All rights reserved</small>

        </div>
        <div class="list-footer d-flex flex-wrap pt-2 pb-3 justify-content-between  me-5">
            <div class="index-footer">
                <ul>
                    <li><a class="footer-link" href="/index.html#genie-section">Genie</a></li>
                    <li><a class="footer-link" href="/index.html#stipple-section">Stipple</a></li>
                    <li><a class="footer-link" href="/index.html#searchlight-section">SearchLight</a></li>
                </ul>
            </div>
            <div class="index-footer">
                <ul>
                    <li><a class="footer-link" href="/docs/index.html">Docs</a></li>
                    <li><a class="footer-link" href="/index.html#blog">Blog</a></li>
                    <li><a class="footer-link" href="/index.html#app-gallery">App Gallery</a></li>
                </ul>
            </div>
            <div class="index-footer genie-cloud">
                <ul>
                    <li><a class="footer-link" href="https://share.hsforms.com/12HgV6VVRRK-rtqoaWiP5Qwchec7" target="_blank">Contact</a></li>
                    <li><a class="footer-link" href="https://geniecloud.io/" target="_blank">Genie Cloud</a></li>
                </ul>
            </div>
        </div>
        <div class="socialmedia-footer pt-2">
            <p class="mt-0">Discover the Genie community through our social media channels 📣</p>
            <div class="icons-footer">
                <a class="footer-discord" href="https://discord.gg/9zyZbD6J7H" target="_blank"><i class="fab fa-discord"></i></a>
                <a class="footer-github" href="https://github.com/GenieFramework" target="_blank"><i class="fab fa-github"></i></a>
                <a class="footer-gitter" href="https://gitter.im/essenciary/Genie.jl" target="_blank"><i class="fab fa-gitter"></i></a>
                <a class="footer-twitter" href="https://twitter.com/geniemvc?lang=en" target="_blank"><i class="fab fa-twitter"></i></a>
            </div>
        </div>
    </div>
</footer>
...
<script src="/assets/external/require.min.js" data-main="/assets/documenter.js"></script>
