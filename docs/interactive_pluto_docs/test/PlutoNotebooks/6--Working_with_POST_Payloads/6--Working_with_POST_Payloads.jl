...
# ╔═╡ ba6b8e18-b39a-4ec5-b817-7028bb9835ed
# hideall

using Genie,Genie.Router,Genie.Renderer.Html,Genie.Requests

# ╔═╡ 3c9d9936-318c-11ec-1a01-a98a4b434a6d
md"""
...
# ╔═╡ 81eac840-b995-45ec-a3f5-293d9a891870
md"""
...
Pkg.add(name="Genie",version="4.4.0")
```
"""

# ╔═╡ 4629c4e5-f4a6-4746-82d4-6f27e96dc41c
md"""
### Example
"""

# ╔═╡ aea7de47-f2b7-4ce4-aa9d-655144ed5861
md"""
...
# ╔═╡ 368ec087-73f1-4f53-9280-95c2c2e08487
# hideall
...
# ╔═╡ cf4c23c9-63d7-4db5-99d6-077769a2f044
# hideall

route("/") do
  Genie.Renderer.Html.html(form)
end;

# ╔═╡ 4af78253-5630-4a2c-aa84-dac285ecfa96
# hideall
...
# ╔═╡ 8c4c514e-4c2a-41d3-a787-4b05b2c50890
# hideall

Genie.Router.routes();

# ╔═╡ 8a3f9d0b-86d3-4821-b2cb-ccae198de2d5
md"""

```julia

julia> up() # start server
julia> down() # stop server
```
"""

# ╔═╡ 0b4754d9-5765-4235-9ecb-283850906cf3
# hideall

up(async=true);

# ╔═╡ 8edf13fd-2db6-4b21-8454-55be3ace7ef4
# hideall

down(); # stopping the server

# ╔═╡ d2e6199f-9e54-49f3-bbbb-ab9ba8aa3aee
md"""
...
git-tree-sha1 = "02fde56046c4ebec4771e84c258bc982f702c96c"
