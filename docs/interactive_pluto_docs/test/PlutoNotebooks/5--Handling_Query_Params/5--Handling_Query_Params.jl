...
# ╔═╡ d8b612b9-36bf-4906-9fe7-55cd50ea2aba
# hideall

using Genie, Genie.Router

# ╔═╡ b3d7c788-2170-4cd5-8198-0311e3dacb40
# hideall

using Genie.Requests

# ╔═╡ 5902c48c-3184-11ec-03b3-d15a63e56026
md"""
...
Adding Genie using Julia's package manager:
```julia
using Pkg
...
# ╔═╡ f770d12e-d4be-4ca2-90cb-7f3815792ae6
md"""
...
# ╔═╡ 7325d302-7e87-435a-8765-5bec1e4687ab
# hideall
...
# ╔═╡ 0aed61f5-ef95-4fe3-926a-af5bb48bf5b8
md"""
starting server async
"""

# ╔═╡ fed91c1f-0ec4-4c5b-a4a0-7a27fca6dd9e
md"""

```julia
julia> up() # start server

julia> down() # shut down server
```
"""

# ╔═╡ 2e46a49a-3e3e-47c4-a0b8-309c8a024709
# hideall

up(async = true);

# ╔═╡ f8d4a74a-973c-40a3-8a1c-e950f3e214e6
# hideall

down();

# ╔═╡ 363a373a-6e37-46bc-a241-77a15ada1fda
md"""
...
# ╔═╡ 9492262c-19d9-4f5e-8e76-45960cd450b6
md"""
...
# ╔═╡ 0800a86b-aa13-466a-aded-06e1e720bddf
# hideall
...
# ╔═╡ da73c06c-0271-46f0-ae40-2852f3c11502
md"""
