...
# ╔═╡ 864ec7b4-680b-4c07-b54c-521e4897d5a7
# hideall

using Genie, Genie.Router

# ╔═╡ a486afe6-316a-11ec-3c48-09b49e9aca8c
md"""
...
# ╔═╡ 7f6498e9-44e5-498e-a81c-cca54d371438
md"""
...
# ╔═╡ 7222af83-c058-4e11-98dc-d995e93fb260
md"""
...
# ╔═╡ 41780b3c-e8dd-48ba-9329-bd301bb7e5d8
md"""
...
# ╔═╡ 0b20eb67-4853-46d8-a439-1766ad5b48a9
# hideall
...
# ╔═╡ c3cfaeec-7cb9-4821-b708-cf07289f92af
md"""
...
# ╔═╡ a180d05a-1977-41ae-82f4-e061d500c43a
# hideall

up(); # to up the server

# ╔═╡ d6647691-1e14-45a5-b9f6-fa8e89d4e26f
md"""
...
# ╔═╡ c5beb412-1b7a-45a1-abe6-3187758d2767
# hideall

down(); # to shutdown the running server

# ╔═╡ 21ac9bab-e8f0-4012-a649-08577715efda
md"""
...
# ╔═╡ 9f5a22bd-362a-428f-ba5f-4e1d07cf49be
md"""
...
# ╔═╡ 2280055c-1fb0-4519-8ba4-84e484307124
md"""
...
begin
	file_written = true;
	write("geniews.jl", """using Genie, Genie.Router
...
```julia
julia> include("geniews.jl")
```
"""

# ╔═╡ 67d40bac-fafd-47a2-ab7a-0d59bea58b42
md"""
