...
function index(params)
  # if isnull(Sessions.get(params[:_session], :first_time_on_site))
  #   Sessions.set!(params[:_session], :first_time_on_site, Dates.now())
  # end
  # fts = Sessions.get(params[:_session], :first_time_on_site)
  # Cookies.set!(params[:_res], "hello", Dates.now())
