...
<html class="no-js" lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Jo - admin</title>
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="stylesheet" href="css/admin/vendor.css">
        <link rel="stylesheet" id="theme-style" href="css/admin/app.css">
    </head>
                ...
                <div class="card">
                    <div class="auth-content">
                        ...
                        <form id="login-form" action="/login" method="POST" novalidate="">
                            <div class="form-group"> <label for="email">Username</label> <input type="email" class="form-control underlined" name="email" id="username" placeholder="Your email address" required> </div>
